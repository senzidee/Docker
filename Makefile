...
help:
	...
	@echo "  build-84-caddy-redis-amqp-grpc-apcu  Build the Docker image for PHP 8.4 with Caddy, Redis, Grpc, Amqp & APCu."
...
build-84-caddy-redis-amqp-grpc-apcu:
	docker build -t ghcr.io/senzidee/docker-php84-caddy-redis-amqp-grpc-apcu:dev --target caddy-redis-amqp-grpc-apcu-dev  PHP84/
